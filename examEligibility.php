...
<table style="margin-left:8px" class="panel">
  	<tr>
        ...
        <td><input name="btnattendance" type="button" value="Disqualified List" class="button" onclick="document.location.href ='examdisList.php'" /></td>
		<td>&nbsp;</td>
...
<?php
 ...
 $resultfinal = $db->executeQuery("Insert into examEligibilty (indexNo,disquliAtend,offend,subjectID,acYear)VALUES ('$indexNovalue','$attendance','$offend','$SubjectID','$acyear')");
		...
		header("location:examEligibility.php");
	}
?>
...
<table class="searchResults">
 ...
 <table class="searchResults">
	<tr>
    	<th>Index No.</th><th>Attendance Disqaulify</th><th>Exam Offend</th>
    </tr>
...
?>
	<tr>
		...
		$querymark1 = "Select * from examEligibilty where subjectID='$SubjectID' and indexNo='$u' and acYear='$acyear'";
         ...
         <td><input name="chk<?php echo $effortid; ?>" type="checkbox" value="<?php echo $effortid ?>" <?php if ($rowmark['disquliAtend'] == 'y') { echo "checked='checked'"; } ?></td>
		<td><input  size="20" name="txtMarks1<?php echo $effortid; ?>" id="txtMarks1<?php echo $effortid;  ?>" value="<?php echo $rowmark['offend'] ?>" type="text" /></td>
