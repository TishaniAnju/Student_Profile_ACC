 ...
 /* if (isset($_POST['txtSearch']) && strlen($_POST['txtSearch'])>0)
  {
	...
	$year=mysql_fetch_array($resultY);
  	$query = "SELECT applicant.appNo,titleE,appType,nameEnglish,qualified,country FROM applicant JOIN foreignapplicant ON foreignapplicant.appNo = applicant.appNo WHERE appType='Foreign' AND entryYear = '$year[0]' ORDER BY appNo";
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
  {
	...
	$query = "SELECT applicant.appNo,titleE,appType,nameEnglish,qualified,country  FROM applicant JOIN foreignapplicant ON foreignapplicant.appNo = applicant.appNo WHERE appType='Foreign' AND entryYear = '$entryYear' ORDER BY appNo";
  }
