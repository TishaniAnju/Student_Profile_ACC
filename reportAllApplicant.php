...
if (isset($_POST['btnSubmit2'])) {
    ...
    header("location:rptAllApplicants_e.php?entryYear=$entryYear&appType=$appType");
}
...
if (isset($_POST['btnSubmit3'])) {
    ...
    header("location:rptAllApplicants_excel.php?entryYear=$entryYear&appType=$appType");
}
