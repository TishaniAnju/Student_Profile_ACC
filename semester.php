<?php
 ...
 /* if (isset($_POST['txtSearch']) && strlen($_POST['txtSearch'])>0)
  {
  	...
  	$query = "SELECT * FROM enrollPeriod ORDER BY id";
 ...
 if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
    ...
    //2021.03.24 end
		...
		$delQuery1 = "DELETE FROM enrollPeriod WHERE id='$id'";
...
<form method="post" action="" class="plain">
  <table style="margin-left:8px"><tr><td><input name="btnNew" type="button" value="New" onclick="document.location.href = 'newsemester.php';" class="button" /></td><td>&nbsp;&nbsp;&nbsp;</td></table>
	<?php 
  ...
  <table class="searchResults">
	<tr>
    	<th>Year</th><th>Semester</th><th>Year Name</th><th>Semester Name</th><th>Start Date</th><th>End Date</th>
        <th colspan="2">&nbsp;</th>
	</tr>
...
?>
	<tr>
      <td><?php echo $row['year'] ?></td>
		...
		<td><input name="btnEdit" type="button" value="Edit" onclick="document.location.href ='editsemesters.php?id=<?php echo $row['id'] ?>'" class="button" /></td>
		<td><input name="btnDelete" type="button" value="Delete" onclick="if (MsgOkCancel()) document.location.href ='semester.php?cmd=delete&id=<?php echo $row['id'] ?>';" class="button" /></td>
	</tr>
<?php
  }  
?>
...
<?php
  ...
  ob_end_clean();
  $pagetitle = "Semester Details - Student Management System - Buddhist & Pali University of Sri Lanka";
  $navpath = "<ul><li><a href='home.php'>Home </a></li><li>Semester Details</li></ul>";
  //Apply the template
