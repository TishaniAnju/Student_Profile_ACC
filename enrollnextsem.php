...
<h1>Student Enrollment for Next Semester</h1>
<?php
  ...
  //	include('authcheck.inc.php');
	...
	{
		$queryall = "Select * from Student_Current where  acyear='$acyear' and level='$level' and  semester='$semester' and active='y' order by RegNo";
  //print  $queryall;
...
if ($level=="I" && $semester=="First Semester"){
    $levelnew="I";
    $semesternew="Second Semester";

}
elseif($level=="I" && $semester=="Second Semester" ){
    $levelnew="II";
    $semesternew="First Semester";

}
elseif($level=="II" && $semester=="First Semester" ){
    $levelnew="II";
    $semesternew="Second Semester";

}
elseif($level=="II" && $semester=="Second Semester" ){
    $levelnew="III";
    $semesternew="First Semester";

}
elseif($level=="III" && $semester=="First Semester" ){
    $levelnew="III";
    $semesternew="Second Semester";
...
$RegNo=$row['RegNo'];
		//print "Insert into exameffort (indexNo,subjectID,mark1,mark2,marks,grade,gradePoint,acYear,effort,medium) VALUES ('$indexNovalue','$SubjectID','$mark1','$mark2','$marks','$grade','$gradepoint','$acyear','$effort','$medium')";
			...
			$result = $db->executeQuery("Insert into Student_Current (RegNo,acyear,level,semester)VALUES ('$RegNo','$acyear','$levelnew','$semesternew')");
            $result1 = $db->executeQuery("Update Student_Current set active='n' where RegNo='$RegNo' and acyear='$acyear' and level='$level' and semester='$semester'");
			//print "Update Student_Current set active='n' where RegNo='$RegNo' and acyear='$acyear' and level='$level' and semester='$semester'";
            //2021-03-25 end
   ...
   <tr>
      ...
      <td><label>
     	  <?php
								...
								$sql="SELECT distinct acyear FROM Student_Current";
...
<br/><br/>
<p><input name="btnCancel" type="button" value="Cancel" onclick="document.location.href = 'enrollnextsem.php';"  class="button"/>&nbsp;&nbsp;&nbsp;<input name="btnSubmit" type="submit" value="Enroll to next Semester" class="button" /></p>
</form>
