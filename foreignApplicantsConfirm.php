<?php
 ...
 /* if (isset($_POST['txtSearch']) && strlen($_POST['txtSearch'])>0)
  {
	...
	//2021-03-24 end
  	$query = "SELECT applicant.appNo,titleE,appType,nameEnglish,qualified,country,confirmed FROM applicant JOIN foreignapplicant ON foreignapplicant.appNo = applicant.appNo WHERE appType='Foreign' AND entryYear = '$year[0]' AND `qualified` LIKE 'Yes' ORDER BY appNo";
	...
	if ($_SERVER['REQUEST_METHOD'] == 'POST')
  {
	...
	$query = "SELECT applicant.appNo,titleE,appType,nameEnglish,qualified,country,confirmed  FROM applicant JOIN foreignapplicant ON foreignapplicant.appNo = applicant.appNo WHERE appType='Foreign' AND entryYear = '$entryYear' AND `qualified` LIKE 'Yes' ORDER BY appNo";
  }
  ...
  else if (isset($_SESSION['entryYear']))
  {
	...
	//2021.03.24 end
		...
		header("location:studentAdminF.php");
 ...
 //2021.03.24 end
	...
	//2021-03-24 end
?>
  <h1>Selected Foreign Applicants</h1>
  <div id="tabs">
  <ul>
    ...
    <li><a href="foreignApplicantsConfirm.php"><span class="current">Foreign Applicants</span></a></li>
  </ul>
</div>
<br/><br/><br/><br/><br/><br/>
 
 <form method="post" action="foreignApplicantsConfirm.php" class="plain">
