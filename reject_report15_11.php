...
<h1> Report of Applicants who have not passed under Pali or Other Pali Qualification  </h1>
...
/* if (isset($_POST['btnSubmit']))
	{
		...
		header("location:reject_report.php?alYear=$alYear&titleE=$title");
...
if (isset($_POST['btnSubmit1']))
	...
	$entryYear = $_POST['lstEntryYear'];
		...
		header("location:rptreject_report.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	 ...
	 if (isset($_POST['btnSubmit2']))
	{
		...
		header("location:rptreject_reportexcel.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
