...
<?php
	...
	{
		 $queryall = "Select * from studentenrolment e, student s where e.subjectID='$SubjectID' and e.acYear='$acyear' and s.medium='$medium'and s.regNo=e.regNo order by e.indexNo";
  //print  $queryall;
...
?>
	<tr>
        ...
        <td><input  size="4" name="txtMarks2<?php echo $effortid ?>" id="txtMarks2<?php echo  $effortid ?>" value="<?php echo $rowmark['mark2'] ?>" onKeyUp="getAverage(<?php echo  $effortid ?>)" type="text" /></td>
