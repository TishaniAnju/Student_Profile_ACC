...
if (isset($_POST['btnSubmit']))
	...
	$entryYear = $_POST['lstEntryYear'];
		...
		header("location:rptpaliqualification.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
...
if (isset($_POST['btnSubmit1']))
	...
	$entryYear = $_POST['lstEntryYear'];
		...
		header("location:rptpaliqualificatione.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	...
	if (isset($_POST['btnSubmit2']))
	{
		...
		header("location:rptpaliqualificationexcel.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	...
	if (isset($_POST['btnSubmit3']))
	{
		...
		header("location:rptpaliqualificationexcelsinhala.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
