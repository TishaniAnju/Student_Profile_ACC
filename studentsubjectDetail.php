...
function quickSearch() {
    ...
    if (regNo.trim() !== "") {
        // Redirect to studentDetails.php with the provided registration number
 ...
 <?php
  ...
  if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
  {
	...
	$delQuery = "DELETE FROM student WHERE regNo='$regNo'";
...
?>
  ...
  <table style="margin-left:8px" class="panel">
  	<tr>
        ...
        <td><input name="txtSearch" id="txtSearch" type="text" placeholder="Registration No." /></td>
	...
	<td><input name="btnstudentConfirm" type="button" value="Student Confirmation" onclick="document.location.href = 'studentConfirm.php';" class="button" /></td>
...
?>
	<tr>
        ...
        <td><input name="btnDetails" type="button" value="Details" onclick="document.location.href ='registationDetails.php?appNo=<?php echo $row['appNo'] ?>'" class="button" /></td>
