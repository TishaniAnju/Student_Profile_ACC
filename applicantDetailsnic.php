...
$nic = $db->cleanInput($_GET['nic']);
  ...
  include('authcheck.inc.php');
	...
	$nic = $db->cleanInput($_GET['nic']);
//=========================================
	$querytype = "SELECT appNo FROM localapplicant  WHERE nicNo='$nic'";
//print $querytype;
