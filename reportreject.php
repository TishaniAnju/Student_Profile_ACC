...
<h1>Rejected Applicant Report</h1>
...
if (isset($_POST['btnSubmit2'])) {
	...
	header("location:rptRejectedApplicant_e.php?entryYear=$entryYear&appType=$appType");
}
...
if (isset($_POST['btnSubmit3'])) {
	...
	header("location:rptRejectedApplicant_excel.php?entryYear=$entryYear&appType=$appType");
}
