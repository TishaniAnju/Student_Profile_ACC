...
<?php
   ...
   //include("authcheck.inc.php");
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$addressEnglish1 =$db-> cleanInput($_POST['txtadd1']);
		$addressEnglish2 = $db->cleanInput($_POST['txtadd2']);
		$addressEnglish3 = $db->cleanInput($_POST['txtadd3']);
		$appType = "Foreign";
		$ppNo = $db->cleanInput($_POST['txtppNo']);
		$country = $db->cleanInput($_POST['txtCountry']);
		$exam = $db->cleanInput($_POST['txtExam']);
		$indexNo = $db->cleanInput($_POST['txtIndex']);
		$year = $_POST['lstYear'];
		$month = $_POST['lstMonth'];
		//$paliQf = $db->cleanInput($_POST['txtPali']);
		$subject = $_POST['txtsubjects'];
    ...
    $guardianname = $db->cleanInput($_POST['txtNameG']);
    $guardianaddressEnglish1 = $db->cleanInput($_POST['txtaddg1']);
		$guardianaddressEnglish2 = $db->cleanInput($_POST['txtaddg2']);
		$guardianaddressEnglish3 = $db->cleanInput($_POST['txtaddg3']);
    $residenceguardianname = $db->cleanInput($_POST['txtNameGR']);
    $residenceaddressEnglish1 = $db->cleanInput($_POST['txtaddgr1']);
		$residenceaddressEnglish2 = $db->cleanInput($_POST['txtaddgr2']);
		$residenceaddressEnglish3 = $db->cleanInput($_POST['txtaddgr3']);
    $residencetelNo = $db->cleanInput($_POST['txttelNoR']);
    $appFee = $db->cleanInput($_POST['appFee']);
		
		 $query1 = "INSERT INTO applicant SET applicationNo='$appNo', entryYear='$entryYear', titleE='$title', nameEnglish='$name'  ,  addressEnglish1 = '$addressEnglish1', addressEnglish2 = '$addressEnglish2' , addressEnglish3 = '$addressEnglish3', appType = '$appType' ";
    ...
    $var = $db->lastID();
		...
		$query2 = "INSERT INTO foreignapplicant SET appNo= '$var', ppNo='$ppNo', country='$country' , exam = '$exam', indexNo = '$indexNo' ,year = '$year', paliQf = '$paliQf' , 
    Nationality = ' $Nationality', 	telNo = '$telNo',telNo1 = '$telNo1',telNo2 = '$telNo2', email = ' $email', gnameE = '$guardianname', gadde1 = '$guardianaddressEnglish1', gadde2 = '$guardianaddressEnglish2', 
    gadde3='$guardianaddressEnglish3',appfee='$appFee', gaNameR='$residenceguardianname', rsladde1=' $residenceaddressEnglish1', rsladde2='$residenceaddressEnglish2', rsladde3='$residenceaddressEnglish3', 	RSLtelNo ='$residencetelNo'";
    ...
    $query3 = "INSERT INTO foreignsubjects SET appNo= '$var', subject='$subject[$a]', result='$grade[$a]'";
    //print  $query3;
...
<tr>
      ...
      <tr>
        <td height="37">Permanent Address - Street</td>
        <td><label>
          <input name="txtadd1" type="text" id="txtadd1" size="50" tabindex="6"  />
        </label></td>
      </tr>
      <tr>
        <td height="45"> <pre><font face="Verdana, Arial, Helvetica, sans-serif" size="2" >  City </font></pre></td>
        <td><input name="txtadd2" type="text" id="txtadd2" size="50" tabindex="7" /></td>
      </tr>
      <tr>
        <td height="45"><pre><font face="Verdana, Arial, Helvetica, sans-serif" size="2" >  Province </font></pre></td>
        <td><input name="txtadd3" type="text" id="txtadd3" size="50" tabindex="8"/></td>
      </tr>
      ...
      <tr>
        ...
        <td><input name="txttelNo1" type="text" id="txttelNo1" tabindex="9" size="20"/></td>
      </tr>

      <tr>
        <td height="34">WhatsApp No</td>
        <td><input name="txttelNo2" type="text" id="txttelNo2" tabindex="9" size="20"/></td>
      </tr>
