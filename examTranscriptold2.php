...
<?php
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		if ($medium=='English')
			header("location:rptTranscriptE.php?type=$type&indexNo=$indexNo&acYear=$acYear&withMarks=$withMarks&exPeriod=$exPeriod");
		else if ($medium=='Sinhala')
			header("location:rptTranscriptS.php?type=$type&indexNo=$indexNo&acYear=$acYear&withMarks=$withMarks&exPeriod=$exPeriod");
	}
?>
