...
<h4 align="center"><font face="kaputadotcom2004" size="+2">Pali Qualification (<?php if($title == 'Ven.'){echo "Monks";}elseif($title=='Mr.'){echo "Boys";}elseif($title=='All'){echo "All";}elseif($title=='Mrs.'){echo "Girls";}elseif($title=='Ms.'){echo "Girls";}?>)</font></h4>
</head>
	...
	//print "SELECT * FROM localapplicant JOIN applicantsubjects ON localapplicant.appNo = applicantsubjects.appNo JOIN applicant ON localapplicant.appNo = applicant.appNo WHERE alYear = '$ALYear' AND subjectCode = '12' AND entryYear='$entryYear' ORDER BY zScore DESC";
	$i =1; 
