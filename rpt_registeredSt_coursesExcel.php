...
$filename = "$L/$sem/$acYear-rpt_Student Registered CoursesExcel-English.xls";
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th rowspan="2" class="sortable-numeric">Registration No</th> <!-- Registration no-->
                <th rowspan="2">Student No</th> <!-- Student no-->
                <th rowspan="2">Medium</th> <!-- Medium -->
