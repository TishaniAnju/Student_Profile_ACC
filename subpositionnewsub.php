...
if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
  {
	...
	//2021-03-25 start  $result = executeQuery("Insert into exameffort (indexNo,subjectID,mark1,mark2,marks,grade,gradePoint,acYear,effort,medium)VALUES ('$indexNovalue','$SubjectID','$mark1','$mark2','$marks','$grade','$gradepoint','$acyear','$effort','$medium')");
			$result = $db->executeQuery("Insert into sub_position (subId,positionId)VALUES ('$SubjectID','$effort')");
...
<table class="searchResults">
   <tr>
	...
	<tr>
    	<td>position : </td>
        <td><select name="lstEffort" id="lstEffort" onchange="document.form1.submit()">
	...
	<table class="searchResults">
	<tr>
    	<th>Code</th><th>Name</th><th>position</th><th colspan="1"></th>
    </tr>
...
<?php
		...
		$queryallsub = $db->executeQuery("SELECT * FROM Newsubject,sub_position WHERE Newsubject.faculty='$faculty' and Newsubject.level='$level' and Newsubject.semester='$semester' and Newsubject.subjectID=sub_position.subId and sub_position.positionId='$effort'");
...
?>
	<tr>
		...
		<td><?php echo $rowallsub['positionId'] ?></td>
        
        <td><input name="btnDelete" type="button" value="Remove" class="button" onclick="if (MsgOkCancel()) document.location.href ='subpositionnewsub.php?cmd=delete&subjectID=<?php echo $rowallsub['subjectID'] ?>'" /></td>
