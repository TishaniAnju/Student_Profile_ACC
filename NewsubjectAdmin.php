...
?>
  ...
  <table style="margin-left:8px" class="panel">
  	<tr>
    	<td><input name="btnNew" type="button" value="New" onclick="document.location.href = 'NewsubjectNew.php';" class="button" /></td>
        ...
        <td>
            ...
            <?php
				...
				$result = $db->executeQuery("SELECT DISTINCT faculty FROM Newsubject");
				//2021-03-23 end
        ...
        <td>
            ...
            <?php
				//2021-03-23 start $result = executeQuery("SELECT DISTINCT level FROM Newsubject");
				$result = $db->executeQuery("SELECT DISTINCT level FROM Newsubject");
        ...
        <td>
            ...
            <?php
				//2021-03-23 start $result = executeQuery("SELECT DISTINCT semester FROM Newsubject");
				$result = $db->executeQuery("SELECT DISTINCT semester FROM Newsubject");
				//if (mysql_num_rows($result)>0)
				if ($db->Row_Count($result)>0)
				//2021-03-23 end
				{
	...
	<tr>
			...
			<td><input name="btnposition" type="button" value="Position" onclick="document.location.href = 'subpositionnewsub.php';" class="button" /></td>
...
?>
	<tr>
		...
		<td><?php echo $posi ?></td>
        <td><input name="btnDetails" type="button" value="Details" onclick="document.location.href ='NewsubjectDetails.php?subjectID=<?php echo $row['subjectID'] ?>'"  class="button" /></td>
        <td><input name="btnEdit" type="button" value="Edit" onclick="document.location.href ='NewsubjectEdit.php?subjectID=<?php echo $row['subjectID'] ?>'" class="button" /></td>
        <td><input name="btnDelete" type="button" value="Delete" class="button" onclick="if (MsgOkCancel()) document.location.href ='NewsubjectAdmin.php?cmd=delete&subjectID=<?php echo $row['subjectID'] ?>'" /></td>
	</tr>
<?php
  }
?>
