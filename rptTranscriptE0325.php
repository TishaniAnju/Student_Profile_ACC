...
<?php 
	...
	$result = executeQuery("SELECT std.nameEnglish,std.degreeType,std.regNo,std.medium,fr.finalGPA,fr.class,sbj.semester,sbj.level FROM student as std,finalresults as fr,subject as sbj  WHERE std.indexNo=fr.indexNo and std.indexNo='$indexNo';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='I' and sbj.semester='First Semester';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='I' and sbj.semester='Second Semester';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='II' and sbj.semester='First Semester';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='II' and sbj.semester='Second Semester';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='III' and sbj.semester='First Semester';");
...
$result = executeQuery("SELECT sbj.subjectID,sbj.codeEnglish,sbj.nameEnglish,exe.grade,sbj.level,sbj.semester FROM subject as sbj,exameffort as exe  WHERE  sbj.subjectID=exe.subjectID and exe.indexNo=$indexNo and sbj.level='III' and sbj.semester='Second Semester';");
