...
<h2 align="center"><font size="+2"><?php echo $entryYear ?> University Entrance</font></h2>
	...
	<thead>
     ...
     <tbody>
    <?php 
	$result = $db->executeQuery("SELECT title, nameEnglish,id_pp_No,regNo,addressE1,addressE2,addressE3 FROM student WHERE yearEntry ='$entryYear' AND confirmed IS NULL ORDER BY regNo");
	$i =1; 
