...
<?php
	...
	{
		 $queryall = "Select * from studentenrolment e, student s  where e.subjectID='$SubjectID' and e.acYear='$acyear'  and s.faculty='$faculty' and s.regNo=e.regNo order by e.indexNo";
  //print  $queryall;
