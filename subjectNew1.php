...
<?php
	...
	{   //2021.11.25 start
		...
		$query = "INSERT INTO subject SET codeEnglish='$codeEnglish', nameEnglish='$nameEngslih', codeSinhala='$codeSinhala', nameSinhala='$nameSinhala', faculty='$faculty', level='$level',spCategory='$spCategory',spRelated='$spRelated',description='$description',semester='$semester',creditHours='$chours',medium='$medium'";
        //2021.11.25 start 
