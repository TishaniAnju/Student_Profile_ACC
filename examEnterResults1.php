  ...
  if (isset($_POST['btnSubmit1']))
	{
		...
		header("location:examEnterResults_excel.php?acYear=$acYear&subjectID=$SubjectID");
	}
?>
...
if(mark1=='AB' && mark2=='AB' ){
	...
	document.getElementById('txtGradePoint'+row).value = '0.0';
		}
...
if (0<=marks && marks<25) {grade = 'E'; gradePoint='0.0';}
	...
	//print $l;
		...
		if($l=='11'){
		  $a=substr($indexNovalue,0,2);
			...
			$b=substr($indexNovalue,8,2);
			$c=substr($indexNovalue,11,3);
			$d=$b.$c;
...
<br/><br/>
<p><input name="btnCancel" type="button" value="Cancel" onclick="document.location.href = 'examAdmin.php';"  class="button"/>&nbsp;&nbsp;&nbsp;<input name="btnSubmit" type="submit" value="Submit" class="button" />&nbsp;&nbsp;&nbsp;<input name="btnSubmit1" type="submit" value="Export to Excel" class="button" /></p>
</form>
