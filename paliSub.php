<?php
 ...
 /* if (isset($_POST['txtSearch']) && strlen($_POST['txtSearch'])>0)
  {
  	...
  	$query = "SELECT * FROM paliqualification ORDER BY code";
 ...
 if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
    ...
    //2021.03.24 end
		...
		$delQuery1 = "DELETE FROM paliqualification WHERE code='$subCode'";
...
<form method="post" action="" class="plain">
  ...
  <table class="searchResults">
	<tr>
    	<th> Code</th><th>Qualification</th><th>Qualification name in English</th>
        <th colspan="2">&nbsp;</th>
	</tr>
...
?>
	<tr>
        ...
        <td><?php echo $row['qualificationE'] ?></td>
		<td><input name="btnEdit" type="button" value="Edit" onclick="document.location.href ='editAlSub.php?subCode=<?php echo $row['code'] ?>'" class="button" /></td>
		<td><input name="btnDelete" type="button" value="Delete" onclick="if (MsgOkCancel()) document.location.href ='alSub.php?cmd=delete&subCode=<?php echo $row['code'] ?>';" class="button" /></td>
	</tr>
<?php
  }  
?>
