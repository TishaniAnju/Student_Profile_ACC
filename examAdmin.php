...
//print $query;
  ...
  else if (isset($_POST['acYear']) && isset($_PSOT['subject']) && isset($_POST['indexNo']))
  {
	$acYear = $_POST['acYear'];
	$subject = $_POST['subject'];
	$student = $_POST['indexNo'];
//print	 $student;
  	$subQuery = filterQuery($acYear,$subject,$student);
	$query = $query.$subQuery;
  }
 ...
 <form method="post" action="" class="plain">
  <table style="margin-left:8px" class="panel">
  	<tr>
        ...
        <td>&nbsp;</td>
        <td><input name="btnEnterResults" type="button" value="Enter Exam Results" class="button" onclick="document.location.href ='examEnterResults1.php'" /></td>
		<td>&nbsp;</td>
		<!--<td><input name="btnEnterResults" type="button" value="Exam Results- Compulsory Subject" class="button" onclick="document.location.href ='examComAdmin.php'" /></td>-->
        <td><input name="btnEnterResults" type="button" value="Exam Eligibilty" class="button" onclick="document.location.href ='examEligibility.php'" /></td>
    </tr>
   </table>
   <table style="margin-left:8px" class="panel">
    <tr>
