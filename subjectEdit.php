...
<?php
	...
	if (isset($_POST['btnSubmit']))
	{
		...
		$query = "UPDATE subject SET codeEnglish='$codeEnglish', nameEnglish='$nameEngslih', codeSinhala='$codeSinhala', nameSinhala='$nameSinhala', faculty='$faculty', level='$level', description='$description', semester='$semester',spCategory='$spCategory',spRelated='$spRelated',creditHours='$chours',medium='$medium' WHERE subjectID='$subjectID'";
