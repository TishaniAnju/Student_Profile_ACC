...
?>
  ...
  <table width="99%" class="panel" style="margin-left:8px">
  <tr> 
      <td width=""><input name="btnSelect" type="submit" id="btnSelect3" value="Present" class="button"/> 
      <td width=""><input type="submit" name="btnDeselect" id="btnDeselect" value="Abcent" class="button" /></td>
	  <td width=""><input name="btnpercentage" type="submit" id="btnpercentage" value="Total attendence"  class="button"/> 
    </tr>
  </table>
  </form>
<?php 
