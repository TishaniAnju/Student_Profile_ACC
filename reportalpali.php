...
<h1> Report of Applicants who have passed the A/L Pali  </h1>
...
if (isset($_POST['btnSubmit']))
	...
	$entryYear = $_POST['lstEntryYear'];
		...
		header("location:rptalpali.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
 ...
 if (isset($_POST['btnSubmit1']))
	{
	 ...
	 $entryYear = $_POST['lstEntryYear'];
		...
		header("location:rptalpalie.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	} 
	...
	if (isset($_POST['btnSubmit2']))
	{
		...
		header("location:rptalpaliexcel.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	}
	...
	if (isset($_POST['btnSubmit3']))
	{
		...
		$title = $_POST['title'];
$entryYear = $_POST['lstEntryYear'];
		header("location:rptalpaliexcelsinhala.php?alYear=$alYear&titleE=$title&entryYear=$entryYear");
	}
...
<br/><br/>
  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
	...
	<input name="btnSubmit3" type="submit" value="Excel Report Sinhala" class="button">
