...
{
    $uname = $_POST['uname'];
    $userdata= $db->Next_Record($db->executeQuery("SELECT description FROM qulidetails WHERE quli_Id ='$uname';"));
    $txtNameE = $userdata[0];
}
    ...
    if (isset($_POST['btnDel']))
	{
        ...
        $query = "DELETE FROM qulidetails WHERE quli_Id ='$uname'; ";
    ...
    else if (isset($_POST['btnEdi']))
	{
        ...
        $query = "UPDATE qulidetails SET description='$txtNameE' WHERE quli_Id ='$uname'; ";
        $result = $db->executeQuery($query);
	}
    else if(isset($_POST['btnAdd']))
	{
        $txtNameE = $db->cleanInput($_POST['txtNameE']);
        $query = "INSERT INTO qulidetails SET description='$txtNameE'; ";
        $result = $db->executeQuery($query);
        $uname = "new";
        $txtNameE="";
	}
   ...
   <tr>
    ...
    <td>
      <?php
       ...
       <option value="new">New Qualification</option>
       <?php
