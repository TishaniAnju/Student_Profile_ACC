...
<?php
		...
		$queryallsub = $db->executeQuery("SELECT * FROM subject,sub_position WHERE subject.faculty='$faculty' and subject.level='$level' and subject.semester='$semester' and subject.subjectID=sub_position.subId and sub_position.positionId='$effort'");
