<?php
 ...
 <?php
  ...
  $query = "SELECT * FROM localapplicant JOIN applicantsubjects ON localapplicant.appNo = applicantsubjects.appNo JOIN applicant ON localapplicant.appNo = applicant.appNo  ";
  ...
  */
   function filterQuery($year,$title)
  {
	...
	// (1,_,_)
		if ($year<>'0')
		{
			$subQuery = " WHERE alYear='".$year."' AND subjectCode = '12' "; 
			// (1,1,_)
			if ($title<>'0')
			{
