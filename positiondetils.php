<?php
 ...
 if (isset($_GET['cmd']) && $_GET['cmd']=="delete")
    ...
    //2021.03.24 end
		...
		$delQuery1 = "DELETE FROM positions WHERE id='$id'";
...
<form method="post" action="" class="plain">
  <table style="margin-left:8px"><tr><td><input name="btnNew" type="button" value="New" onclick="document.location.href = 'newsubposition.php';" class="button" /></td><td>&nbsp;&nbsp;&nbsp;</td></table>
	<?php 
...
?>
    ...
    <td><?php echo $row['position'] ?></td>
		...
		<td><input name="btnDelete" type="button" value="Delete" onclick="if (MsgOkCancel()) document.location.href ='positiondetails.php?cmd=delete&id=<?php echo $row['id'] ?>';" class="button" /></td>
	</tr>
<?php
  }  
?>
