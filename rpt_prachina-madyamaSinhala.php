...
<head>
	...
	<h1 align="center">
		<font size="+3">ශ්‍රී ලංකා බෞ‍ද්ධ හා පාලි විශ්වවි‍ද්‍යාලය</font>
	</h1>
	<h2 align="center">
		<font size="+2"><?php echo $entryYear ?>/ <?php echo $entryYear + 1 ?> විශ්වවි‍ද්‍යාල ප්‍රවේශය</font>
	</h2>
	<h3 align="center">
		<font size="+2"> අයදුම් කර ඇති සිසුන්ගේ නාම ලේඛනය - ???????????? ????(
			<?php
			if ($title == 'Ven.') {
				echo "  පූජ්‍ය ";
			} elseif ($title == 'Mr.') {
