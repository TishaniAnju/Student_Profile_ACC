...
$filename ="rpt_prachina-madyamaExcel-English.xls";
...
<head>
	...
	<h4 align="center"><font face="kaputadotcom2004" size="+2">Prachina Madyama Examination.(
            <?php
            if ($title == 'Ven.') {
                echo "Monks";
            } elseif ($title == 'Mr.') {
	...
	<table border="1" cellpadding="2" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th class="sortable-numeric" rowspan="2"><font>No:</font></th> <!-- index No-->
