  ...
  <table style="margin-left:8px" class="panel">
  	<tr>
        ...
        <td>
            ...
            <?php
				//2021.03.24 start  $result = executeQuery("SELECT acYear FROM examschedule");
...
<?php
  ...
  ob_end_clean();
  $pagetitle = "Exam Schedule - Student Management System - Buddhist & Pali University of Sri Lanka";
